...
print(f"Total regional sales for {video_game_sales[0][NAME]}: ${result}M")
...
print(f"\nDefault genre (Platform) — {len(platform_games)} games found:")
for game in platform_games:
    print(f"  {game[NAME]}")

racing_games = filter_by_genre(video_game_sales, 'Racing')
print(f"\nRacing genre — {len(racing_games)} games found:")
for game in racing_games:
    print(f"  {game[NAME]}")
